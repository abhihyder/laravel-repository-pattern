...
@section('title', 'AIRSHIPT | Add Parcel Station')
@section('content')
...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="javascript:;">Add Parcel Station</a>
            </li>
        </ol>
    </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Add Parcel Station</h5>

                </div>
                <div class="ibox-content">
                    <form id="parcelStationForm">
                        @csrf
                        @method('POST')
                                ...
                                <div class="form-group  row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control m-b select2" name="admin_id" id="admin_id">
                                            ...
                                            {{generate_simple_dropdown('admins', 'name')}}
                                        </select>
                                ...
                                <div class="form-group  row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control m-b select2" name="country_id" id="country_id">
                                            <option value="">Select</option>
                                            {{generate_simple_dropdown('countries', 'name')}}
                                        </select>
...
<script>
    ...
    $('#parcelStationForm').submit(function(event) {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "{{route('ship.parcel_station.store') }}",
            data: $(this).serialize(),
            success: function(response) {
                successMsg('Parcel Station  added successfully!');
                window.location.href = "{{url('admin/parcel_station/create') }}"
            },
